#! /bin/sh
### BEGIN INIT INFO
# Provides and Short-Description
# Provides:          ScheduledTasks app
# Required-Start:    $remote_fs $syslog
# Required-Stop:     $remote_fs $syslog
# Default-Start:     2 3 4 5
# Default-Stop:      0 1 6
# Short-Description: initscript for ScheduledTasks app
### END INIT INFO

# Author:  Luciano Giannelli <lucho_aglp@hotmail.com>
...
NAME="ScheduledTasks"
CWD=/home/sistemas/scripts
USER=root
GROUP=root
JAVA=/usr/bin/java
JVM_ARGS=
JAR_PATH=/home/sistemas/scripts/ScheduledTasks.jar
